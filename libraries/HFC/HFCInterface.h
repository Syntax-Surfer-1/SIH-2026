...
#ifndef __HFC_INTERFACE_H__
#define __HFC_INTERFACE_H__

#include <stdint.h>

#define HFC_PREAMBLE                (0x00)
#define HFC_STARTCODE1              (0x00)
#define HFC_STARTCODE2              (0xFF)
#define HFC_POSTAMBLE               (0x00)

#define HFC_HOSTTOHFC             (0xD4)
#define HFC_HFCTOHOST             (0xD5)

#define HFC_ACK_WAIT_TIME           (10)  // ms, timeout of waiting for ACK

#define HFC_INVALID_ACK             (-1)
#define HFC_TIMEOUT                 (-2)
#define HFC_INVALID_FRAME           (-3)
#define HFC_NO_SPACE                (-4)
